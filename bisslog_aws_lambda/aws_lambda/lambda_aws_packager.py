...
class LambdaAWSPackager:
    """
    Packages a Lambda deployment zip file by collecting `.py` source files and
    inserting a specified handler file as `lambda_function.py`.
    """
    ...
    def generate_zip_file(
        ...
        src_paths = self._resolve_src_paths(src_folders, handlers_folder)
